...
- [ ] Création de la page
  ...
  -[ ] Creation de la page ficheEtu - [ ] Creation de la route "/etud/id" - [ ] Modification du controller "NoteController" - [ ] Creation de la fonction supprimerNote(id, id_etu,id_matiere) - [ ] Creation de la fonction findAllNotesByoption(id_etu) - [ ] Creation de la fonction findAllMoyenneByYear(id_etu) - [ ] Creation de la fonction findAllMoyenneBySemestre(id_etu) - [ ] Modification du model "NoteModel" - [ ] creation de la fonction findAllNotesByOption(id_etu) - [ ] Creation de la fonction findAllMoyenneByYear(id_etu) - [ ] Creation de la fonction findAllMoyenneBySemestre(id_etu)
